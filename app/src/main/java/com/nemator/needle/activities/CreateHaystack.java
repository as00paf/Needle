...
public class CreateHaystack extends AppCompatActivity implements ImageUploaderTask.ImageUploadResponseHandler,
    ...
    private BroadcastReceiver apiConnectedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            LocalBroadcastManager localBroadcastManager = LocalBroadcastManager.getInstance(CreateHaystack.this);
