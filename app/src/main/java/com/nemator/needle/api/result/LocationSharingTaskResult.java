...
public class LocationSharingTaskResult extends TaskResult {
    ...
    public LocationSharingTaskResult() {
    }

    public LocationSharingTaskResult(int successCode, String message, LocationSharingVO locationSharing, ArrayList<LocationSharingVO> locationSharings, ArrayList<LocationSharingVO> receivedLocationSharings, ArrayList<LocationSharingVO> sentLocationSharings) {
