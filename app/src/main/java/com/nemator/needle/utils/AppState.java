...
public class AppState {
    public static final int SPLASH_LOGIN = 0;
    public static final int LOGIN = 1;
    public static final int REGISTER = 2;
    public static final int PUBLIC_HAYSTACK_TAB = 3;
    public static final int PRIVATE_HAYSTACK_TAB = 4;
    public static final int CREATE_HAYSTACK_GENERAL_INFOS = 5;
    public static final int CREATE_HAYSTACK_MAP = 6;
