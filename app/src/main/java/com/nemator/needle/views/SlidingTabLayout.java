...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * (number of tabs and tab titles) does not change after this call has been made.
     */
    public void setViewPager(ViewPager viewPager, Toolbar toolbar) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ImageView tabView = createDefaultImageView(getContext());
            ...
            //Set Actionbar title
            if(actionBar != null){
                actionBar.setTitle(adapter.getPageTitle(i));
            }

            //Set Icon
            tabIconView = tabView;
            tabIconView.setImageDrawable(getContext().getResources().getDrawable(adapter.getDrawableId(i)));
