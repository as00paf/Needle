...
public interface ViewTransformer {
     ...
     */
    void transformView(float translation, float maxTranslation, float peekedTranslation, CustomBottomSheetLayout parent, View view);
     ...
     */
    float getDimAlpha(float translation, float maxTranslation, float peekedTranslation, CustomBottomSheetLayout parent, View view);
